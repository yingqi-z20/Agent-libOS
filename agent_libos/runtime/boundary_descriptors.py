...
PRIMITIVE_BOUNDARIES = (
    ...
    boundary("mcp", "list_resources", "primitive", "primitive.mcp.resources.list", "actor", "actor"),
    boundary("mcp", "list_resource_templates", "primitive", "primitive.mcp.resource_templates.list", "actor", "actor"),
    boundary("mcp", "read_resource", "primitive", "primitive.mcp.resources.read", "actor", "actor"),
    boundary("mcp", "list_prompts", "primitive", "primitive.mcp.prompts.list", "actor", "actor"),
    boundary("mcp", "get_prompt", "primitive", "primitive.mcp.prompts.get", "actor", "actor"),
    boundary("mcp", "complete_prompt", "primitive", "primitive.mcp.completion.complete", "actor", "actor"),
    boundary("mcp", "start_subscription", "primitive", "primitive.mcp.subscriptions.start", "actor", "actor"),
    boundary("mcp", "subscription_status", "primitive", "primitive.mcp.subscriptions.status", "actor", "actor"),
    boundary("mcp", "subscription_events", "primitive", "primitive.mcp.subscriptions.events", "actor", "actor"),
    boundary("mcp", "stop_subscription", "primitive", "primitive.mcp.subscriptions.stop", "actor", "actor"),
    boundary("mcp", "respond_continuation", "primitive", "primitive.mcp.continuation.respond", "actor", "actor"),
    boundary("mcp", "cancel_continuation", "primitive", "primitive.mcp.continuation.cancel", "actor", "actor"),
    boundary("mcp", "get_remote_task", "primitive", "primitive.mcp.tasks.get", "actor", "actor"),
    boundary("mcp", "update_remote_task", "primitive", "primitive.mcp.tasks.update", "actor", "actor"),
    boundary("mcp", "cancel_remote_task", "primitive", "primitive.mcp.tasks.cancel", "actor", "actor"),
    boundary("mcp", "auth_begin", "primitive", "primitive.mcp.auth.begin.internal", "actor", "actor"),
    boundary("mcp", "auth_authorize_for_challenge", "primitive", "primitive.mcp.auth.challenge.internal", "actor", "actor"),
    boundary("mcp", "auth_complete", "primitive", "primitive.mcp.auth.complete.internal", "actor", "actor"),
    boundary("mcp", "auth_revoke", "primitive", "primitive.mcp.auth.revoke.internal", "actor", "actor"),
    boundary("mcp", "auth_status", "runtime", "mcp.oauth.status", "actor", "actor"),
    boundary("mcp", "list_oauth_profiles", "runtime", "mcp.oauth.profile.list", "actor", "actor"),
    boundary("mcp", "add_oauth_profile", "runtime", "mcp.oauth.profile.add", "actor", "actor"),
    boundary("mcp", "replace_oauth_profile", "runtime", "mcp.oauth.profile.replace", "actor", "actor"),
    boundary("mcp", "remove_oauth_profile", "runtime", "mcp.oauth.profile.remove", "actor", "actor"),
    boundary("mcp", "auth_logout", "runtime", "mcp.oauth.logout", "actor", "actor"),
